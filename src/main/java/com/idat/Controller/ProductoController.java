...
public class ProductoController {
	...
	public ResponseEntity<List<Producto>> listar(){//INTERACTUA CON HTTP
	...
	public ResponseEntity<Producto> obtenerPorId(@PathVariable Integer id){
		...
		Producto producto = service.obtener(id);//VALIDO QUE EXISTA
		if(producto != null) {
	...
	public ResponseEntity<Void> editar(@RequestBody Producto producto){
		...
		Producto p = service.obtener(producto.getIdProducto());//VALIDO QUE EXISTA
		if(p != null) {
